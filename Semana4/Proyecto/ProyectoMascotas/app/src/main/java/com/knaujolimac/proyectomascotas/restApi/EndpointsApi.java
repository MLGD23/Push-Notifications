...
public interface EndpointsApi {
    ...
    @GET(ConstantesRestApi.URL_POST_GET_RELATIONSHIP)
    Call<UsuarioFollowResponse> obtenerInfoRelacionUsuario(@Path("idUsuario") String idUsuario);

    @FormUrlEncoded
    @POST(ConstantesRestApi.URL_POST_GET_RELATIONSHIP)
    Call<UsuarioFollowResponse> modificarRelacionUsuario(@Path("idUsuario") String idUsuario, @Field("action") String tipoAccion);
