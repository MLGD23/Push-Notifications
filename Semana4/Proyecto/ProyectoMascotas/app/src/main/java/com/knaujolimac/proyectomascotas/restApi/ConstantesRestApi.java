...
public class ConstantesRestApi {
    ...
    public static final String KEY_POST_GET_RELATIONSHIP= "users/{idUsuario}/relationship";
    public static final String URL_POST_GET_RELATIONSHIP= KEY_POST_GET_RELATIONSHIP + CONECTOR +
            KEY_ACCESS_TOKEN + ASIGNACION + ACCESS_TOKEN ;
    ...
    //Constantes deserializar Instagram
    public static final int DESEREALIZAR_USUARIOS_FOLLOW = 1;
    public static final int DESEREALIZAR_RELATIONSHIP = 2;
    public static final String ACTION_FOLLOW = "follow";
    public static final String ACTION_FOLLOW_RESPUESTA = "follows";
    public static final String ACTION_UNFOLLOW = "unfollow";
    public static final String USUARIO_LIKE = "USUARIO_LIKE";
